    ...
    <>
      <section className="bg-blue-200 py-12">
        <div className="max-w-screen-lg mx-auto grid grid-col-1 px-2 items-center md:flex justify-between">
          <div className="pr-12">
            <h1 className="text-gray-600 text-2xl font-semibold mb-2">Newsletter - Stay tuned and get the latest update</h1>
            <span className="text-gray-600 ">Far far away, behind the word mountains</span>
          </div>
