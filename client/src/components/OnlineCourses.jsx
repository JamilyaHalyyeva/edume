...
export const OnlineCourses = () => {
  return (
    <>
 <section className="online bg-lime-50 pb-10 py-10" id="lessons">
    <div className=" max-w-screen-lg mx-auto">
        <Title subtitle="CLASSES" title="Browse Our Online classes" />
        <div className="grid grid-cols-2 px-2 gap-6 md:grid-cols-4 sm:grid-cols-2">
            {onlineLessons.map((item) => (
                <div key={item.id} className="p-8 w-70 rounded-md  shadow-lg bg-white transition duration-500 flex flex-col items-center justify-center cursor-pointer"> {/* Added flex classes to center the content */}
