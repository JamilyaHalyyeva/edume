      ...
      <section className=" py-12 justify-center ml-10 mr-10 mt-14 md:ml-0 md:mr-0 md:mt-20 sm:mr-0 sm:mt-20 xs:ml-0 xs:mr-0 xs:mt-20 bg-white">
        <div className="text-orange-500 text-center">
          ...
          <h1 className="text-3xl text-gray-800 font-extralight mb-6">
            Our PricePlan For both Teachers and Students.
          </h1>
        </div>
        <div className=" max-w-screen-md mx-auto grid md:grid-cols-2 p-10">
          {price.map((item, index) => (
            <div
              key={index}
              className="shadow-2xl py-8 px-8 text-center rounded-2xl mb-8 justify-center sm:w-80 bg-white md:w-62  flex-row"
            >
              <div className="bg-yellow-100">
                <img src={item.cover} alt="" />
              </div>
              <h3 className="text-2xl font-semibold text-orange-500 md:text-2xl pt-6">
                {item.type}
              </h3>
        ...
        <div className="text-gray-500 text-center">
          <h1 className="text-2xl font-light mb-4">
            These offers are only available to teachers, teacher trainees, and
            teaching interns.{" "}
          </h1>
          <h1 className="text-xl font-extralight mb-6 text-orange-500">
            To qualify, we require a current proof of status from you. What
            counts as proof of status?
          </h1>
          <div className="flex justify-center">
            <img
              src="https://dkckbwr4t7ug6.cloudfront.net/assets/application/pricing/promote_app-19feb71a83caa5afcd81fbca9a404b2c7d6fd647da93bdbc3766d6dc6e0bab41.svg"
              alt=""
              className="item-center"
            />
          </div>
          <h1 className="text-2xl font-light mb-4 mt-6">
            In browser or in App,{" "}
          </h1>
          <h1 className="text-xl font-extralight mb-6 text-orange-500">
            Learning Motivated anywhere....
          </h1>
          <div></div>
        </div>
      </section>
